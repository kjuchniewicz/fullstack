...
import (
	...
	"github.com/kjuchniewicz/fullstack/api/auth"
	"github.com/kjuchniewicz/fullstack/api/models"
	"github.com/kjuchniewicz/fullstack/api/responses"
	"github.com/kjuchniewicz/fullstack/api/utils/formaterror"
)
...
func (server *Server) UpdateUser(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		responses.ERROR(w, http.StatusUnauthorized, errors.New("nieautoryzowany"))
		return
	}
